...
public class IO {
      ...
      public static void writeFile(String filePath, String[] rows) {
            try ( PrintWriter file = new PrintWriter( new FileWriter(filePath) ) ) {   for (String row : rows) file.println(row);    }
            catch (IOException e) { System.err.println("Error writing file: " + e.getMessage()); }
      }
      public static void writeFile(String filePath, String content) {
            try ( PrintWriter file = new PrintWriter( new FileWriter(filePath) ) ) {   file.print(content);    }
            catch (IOException e) { System.err.println("Error writing file: " + e.getMessage()); }
      }
      ...
      public static void writeBinFile(String filePath, int[] bytes) {
            try ( FileOutputStream out = new FileOutputStream(filePath) ) {   for (int b : bytes) out.write(b);    }
            catch (IOException e) { System.err.println("Error writing file: " + e.getMessage()); }
      }
